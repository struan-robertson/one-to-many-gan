...
CONFIG = {
    ...
    "ada_adjustment_size": 5.12e-4,  # ADA adjustment amount per image, multiplied by ada_E
    "adam_betas": (0.5, 0.99),
...
if torch.cuda.is_available():
    ...
    if CONFIG["deterministic_cuda_kernels"]:
...
dataloader_g.manual_seed(CONFIG["random_seed"])
